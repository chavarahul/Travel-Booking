  ...
  return (
    <div className="min-h-screen w-full">
      ...
      <div className="relative z-20 -mt-12 h-full w-full flex flex-col items-center">
        <form className="border w-2/3 h-28 border-slate-500 px-4 py-12 rounded-xl bg-blue-600 text-white flex items-center justify-between" >
        ...
        <div className="w-full mt-36 flex flex-wrap justify-center items-center gap-14">
          {data?.length > 0 ? data.map((place:Hotel, idx:number) => (
            <Card
              key={idx}
              loc={place}
            />
